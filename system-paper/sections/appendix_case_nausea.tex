...
artifacts); \emph{all} source titles and page numbers are withheld and replaced
with neutral labels (``reference text~A''--``D''), with full per-document
provenance in the corpus manifest. The crux is that two of the chunks come from
the \emph{same} source (``reference text~A'')---one its definition, the other
its management protocol. Bracketed numbers \mbox{[1]--[3]} mark the retrieval
order and match the citations in the generated answers.
...
\smallskip
\noindent\emph{[1] Reference text~A --- the management section.}
...
\noindent\emph{[2] Reference text~D --- the rationale.}
\begin{quote}\footnotesize
...
\noindent\emph{[3] Reference text~D --- the recommendations.}
\begin{quote}\footnotesize
...
\smallskip
\noindent\emph{[1] Reference text~B --- a general management section.}
\begin{quote}\footnotesize
\textbf{Management}
...
\noindent\emph{[2] Reference text~C --- a student study-exercise.}
\begin{quote}\footnotesize
\textbf{Activity}
...
\noindent\emph{[3] Reference text~A --- the definition section} (from the
\emph{same} source as the management section in Case~A).
\begin{quote}\footnotesize
