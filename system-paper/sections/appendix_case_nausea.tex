...
lives in the corpus manifest in the project repository). The crux is that two
of the chunks come from the \emph{same} source (``reference text~A'')---one its
...
\begin{enumerate}\setlength{\itemsep}{1.5pt}
  ...
  \item \emph{Reference text~D --- recommendations.} Reassure that
  mild-to-moderate nausea and vomiting is common and usually resolves by
  16--20 weeks; recognise that women have often already tried remedies before
  seeking advice; and offer ginger as a non-pharmacological option.
  \item \emph{Reference text~D --- rationale.} Notes that hyperemesis can have
  serious consequences and may need hospital care, and that this source
...
\begin{enumerate}\setlength{\itemsep}{1.5pt}
  ...
  clinical guidance at all: an activity asking the reader to
  ...
  \emph{same} source as the management section retrieved in Case~A). Definition and
