...
unjudged---but the same audit bounds it: measured against every relevant chunk
known from both judging rounds, widening from the initial pool to the
five-retriever top-20 union raised lenient recall from about 0.49 to about
0.99, and the released pool adds a sixth retriever, so it is near-saturated at
the top of the ranking. Only absolute coverage-sensitive
